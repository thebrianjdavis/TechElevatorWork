...
SELECT name, lifeexpectancy
FROM country
WHERE continent LIKE '%oceania%' AND lifeexpectancy IS NOT NULL;
...
SELECT name, lifeexpectancy
FROM country
WHERE continent LIKE '%oceania%' AND lifeexpectancy IS NULL;
