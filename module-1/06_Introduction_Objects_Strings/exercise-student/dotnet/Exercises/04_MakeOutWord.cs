namespace Exercises
{
    public partial class StringExercises
    {
        ...
        */
        ...
        {
            string makeOutWordSolve = "";
            
            string firstTwoChars = outword.Substring(0, 2);
            string lastTwoChars = outword.Substring(outword.Length - 2, 2);

            makeOutWordSolve = firstTwoChars + word + lastTwoChars;

            return makeOutWordSolve;
        }
    }
}
